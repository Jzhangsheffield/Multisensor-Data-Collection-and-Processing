...
def main():
    ...
    parser.add_argument("--out_csv", type=str, default="segments.csv",
    ...
    start_idx = None
    end_idx = None
    # 每个元素：dict(action, object, [hand], start, end, mark, start_idx, end_idx)
    segments = []
    ...
    while True:
        ...
        # ============== 新建片段 (N) ==============
            ...
            while True:
                ...
                action_text = action_text.strip()  # 去掉首尾空格
            ...
            if obj_text == ".":
                ...
                obj = obj_text.strip()   # 可以是空字符串，但去掉两端空格
            ...
            if args.use_hand:
                ...
                if hand_text == ".":
                    ...
                    if low == "l":
                        ...
                        hand = hand_text   # 任意字符串（已 strip，可为空）
            else:
                hand = None  # 不标注手
            ...
            mark = mark_text.strip()     # 去掉首尾空格，可为空
            ...
            seg_record = {
                ...
                "end": end_name,
                "mark": mark,
                "start_idx": s_idx,   # 0-based；如果希望 CSV 中从 1 开始，可以在写出时 +1
                "end_idx": e_idx,
            }
            if args.use_hand:
            ...
            if args.use_hand:
                print(
                    ...
                    f"start={start_name} (idx={s_idx+1}), end={end_name} (idx={e_idx+1}), "
    ...
    if segments:
        ...
        with out_path.open("w", newline="", encoding="utf-8") as f:
            ...
            for i, seg in enumerate(segments, start=1):
                row = {
                    "No": i,
                    "start_idx": seg["start_idx"],   # 如要 1-based：seg["start_idx"] + 1
                    "end_idx": seg["end_idx"],
                    "action": seg["action"],
                    "object": seg["object"],
                    "start": seg["start"],
